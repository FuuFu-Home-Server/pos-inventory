export default function ImportPage() {
  return (
    <div className="p-6">
      ...
      <p className="text-gray-500 text-sm mb-6">Migrasi data dari sistem lama (Firebird/InterBase .GDB)</p>
        ...
        <div className="flex items-start gap-3">
          <div>
            ...
            <ul className="text-sm text-yellow-700 mt-1 space-y-1 list-disc pl-4">
              ...
              <li>BARANG + ISIAN2 → Product + ProductVariant (harga, stok, barcode dari KODE_LAIN, HPP dari HRG_BELI)</li>
            </ul>
          </div>
        </div>
      </div>
