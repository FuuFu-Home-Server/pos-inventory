...
export default function SupplierPage() {
  const { suppliers, total, page, pageSize, setPage, setPageSize, search, setSearch, modalOpen, setModalOpen, editing, form, setForm, loading, openCreate, openEdit, handleSave, handleDelete } = useSupplier()
