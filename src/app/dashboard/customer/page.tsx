...
export default function CustomerPage() {
  const { customers, total, page, pageSize, setPage, setPageSize, search, setSearch, modalOpen, setModalOpen, editing, form, setForm, loading, openCreate, openEdit, handleSave, handleDelete } = useCustomer()
